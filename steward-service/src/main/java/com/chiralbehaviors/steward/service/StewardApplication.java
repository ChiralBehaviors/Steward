 ...
 */
package com.chiralbehaviors.steward.service;
...
/**
 * Application server for REST API for Steward
 * 
 * @author hhildebrand
 * 
 */
public class StewardApplication
        extends Application<StewardApplicationConfiguration> {

    public static void main(String[] argv) throws Exception {
        new StewardApplication().run(argv);
    }
    ...
    @Override
    public void initialize(Bootstrap<StewardApplicationConfiguration> bootstrap) {
        bootstrap.addBundle(new AssetsBundle("/angular", "/angular", null,
                                             "phantasm"));
        bootstrap.addBundle(new AssetsBundle("/ui", "/ui", null, "steward"));
